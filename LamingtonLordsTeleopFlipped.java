...
@TeleOp(name="Lamington Lords Teleop Flipped", group="Final Day")

public class LamingtonLordsTeleopFlipped extends OpMode

{
    ...
    public LamingtonLordsTeleopFlipped() {
...

    {
        ...
        cs = hardwareMap.get(ModernRoboticsI2cColorSensor.class,"Color");
        cs.enableLed(true);
...

    {
       ...
       // update_telemetry();
        ...
        telemetry.addData("COLOR", "Red: "+cs.red() + " ARGB: "+cs.argb());
